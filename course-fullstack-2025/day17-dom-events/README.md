...
- ✅ ใช้ `getElementById` และ `querySelector` อย่างถูกต้อง
- ✅ ใช้ `addEventListener` สำหรับ `click`, `input`, หรือ `keydown`
- ✅ มีการเปลี่ยนแปลง DOM เช่น `innerText`, `style`, `classList`
- ✅ โค้ดทำงานได้สมบูรณ์ใน browser
- ✅ ไม่มีการใช้ `{{}}` หลงเหลือ
- ✅ ไม่มี Quiz ❌ หรือ Homework ❌
- ✅ โครงสร้าง README ตรงตามเทมเพลต
- ✅ มีการเขียน output ตัวอย่างใน Section “Expected Output”
