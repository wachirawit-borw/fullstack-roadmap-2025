...
| รหัสบท | หัวข้อหลัก                             | หัวข้อย่อย                                                                                                                                                           | ผลลัพธ์จับต้องได้                                                |
| ------ | -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| FS-01  | Tailwind Sprint – Hero Remix        | – ติดตั้ง Tailwind CLI หรือ CDN<br>– แปลง Hero Section ของ Day10 เป็นคลาส Tailwind<br>– ใช้ breakpoint `sm`, `md`, `lg`                                              | หน้า Hero ตอบสนองทุกขนาดจอด้วย class Tailwind                  |
| FS-02  | Tailwind Sprint – Component Kit     | – สร้าง Button, Card, Navbar ด้วย Tailwind + DaisyUI<br>– ตั้ง Storybook หรือ docs page เล็ก ๆ                                                                        | Mini UI‑library พร้อมแชร์/รียูส                                  |
...
| รหัสบท | หัวข้อหลัก                             | หัวข้อย่อย                                                                                                                                                           | ผลลัพธ์จับต้องได้                                                |
| ------ | -------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| FS-03  | React Sprint – Counter + Todo       | – สร้างโปรเจกต์ Vite + React + TypeScript<br>– ใช้ `useState`, `props`, `map` เพื่อจัดการ state                                                                      | SPA Counter + Todo live บน GitHub Pages                           |
| FS-04  | React Sprint – Next.js Taste Test   | – สร้างหน้าเดียวใน Next.js<br>– ใช้ file‑based routing + SSR<br>– Integrate Tailwind                                                                                 | เดโม่ Next.js + Tailwind deploy บน Vercel                        |
